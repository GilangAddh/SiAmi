...
<div class="px-5 py-4">
    ...
    <div class="flex justify-between my-6 items-end flex-wrap gap-2">
        <div class="w-full sm:w-1/2 md:1/3 lg:w-[30%] flex justify-between items-center sm:items-end gap-2">
            <div class="flex flex-row sm:flex-col gap-2 w-full">
                <label class="input input-bordered flex items-center input-sm py-5 pr-4 pl-1">
                    <input type="text"
                        class="focus:outline-none focus:ring-0 grow border-none text-sm gap-2 w-full flatpickr-free"
            ...
            <button class="btn text-white btn-sm bg-[#60c0d0] border-none px-3 text-sm"
                wire:click='resetSearch'>Hapus</button>
        </div>
